...
1. **Fabric workspace** with sufficient permissions to create and manage custom environments.
    ...
    1. Create a folder "data" and subfolder "customer-profile-sample-data" in lakehouse. Download the sample data file: `customers-sampledata.csv` and upload in the Lakehouse subfolder.<br>
